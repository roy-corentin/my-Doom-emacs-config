#+TITLE: JilkoniX GNU Emacs Config
...
- [[#move-between-mode][MOVE BETWEEN MODE]]
...
- [[#typescript-react-config][TYPESCRIPT REACT CONFIG]]
- [[#configuration-dap-for-python][CONFIGURATION DAP FOR PYTHON]]
...
** Center Org Mode
Center document as a word file
