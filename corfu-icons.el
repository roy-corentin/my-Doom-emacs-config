...
(defvar my-corfu-icons
  '((array :style "cod" :icon "symbol_array" :face font-lock-type-face)
    ...
    (class :style "md" :icon "sigma" :face font-lock-type-face)
    ...
    (field :style "md" :icon "beta" :face font-lock-variable-name-face)
    ...
    (method :style "md" :icon "omega" :face font-lock-function-name-face)
    ...
    (variable :style "md" :icon "epsilon" :face font-lock-variable-name-face)
